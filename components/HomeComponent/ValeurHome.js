...
const ValeurHome = () => {
  return (
    <section className='expertise_container  valeur_home'>
      <div className='container_expertise container row'>
        <h2 className='heading-2'>Nos Valeurs</h2>
        <div className='expertise col-xs-12 col-md-6'>
          <div className='discreption'>
            <p>
              AGEXIS fait de ses projets et référence signification met en avant
              la synergie de son organisation et de son processus qualité, de
              ses talent projets contracté dans le cadre de ses engagements
              éthique et opérationnelles
            </p>
          </div>
          <div className='type-expetise'>
            <div className='type '>
              ...
              <div className='définitions'>
                ...
                <p>
                  Nous cherchons des partenariats stratégiques à long terme.
                </p>
              </div>
            </div>
            <div className='type '>
